...
class Kcwi_pipeline(BasePipeline):
    ...
    event_table = {
        ...
        "object_correct_gain":       ("CorrectGain",
                                      "gain_correction_started",
                                      "object_correct_biasdrift"),
        "object_correct_biasdrift":  ("BiasDriftCorr",
                                      "bias_correction_started",
        ...
        "process_nandshuff":         ("ProcessObject",
                                      ...
                                      "nandshuff_subtract_sine"),
        "nandshuff_subtract_sine":   ("SubtractSinePattern",
                                      "nandshuff_subtract_sine_started",
